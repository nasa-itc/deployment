...
# and are running this script inside the copy.
#
...
git submodule add -f -b nos3-main https://github.com/nasa-itc/arducam.git ./components/arducam
git submodule add -f -b nos3-main https://github.com/nasa-itc/generic_reaction_wheel.git ./components/generic_reaction_wheel
git submodule add -f -b nos3-main https://github.com/nasa-itc/novatel_oem615.git ./components/novatel_oem615
git submodule add -f -b nos3-main https://github.com/nasa-itc/sample.git ./components/sample
...
git submodule add -f -b nos3-main https://github.com/nasa-itc/hwlib.git ./fsw/apps/hwlib
...
git submodule add -f -b nos3-main https://github.com/nasa-itc/gsw-ait.git ./gsw/ait
git submodule add -f -b nos3-main https://github.com/nasa-itc/gsw-cosmos.git ./gsw/cosmos
git submodule add -f -b nos3-main https://github.com/nasa-itc/OrbitInviewPowerPrediction.git ./gsw/OrbitInviewPowerPrediction
...
git submodule add -f -b nos3-main https://github.com/nasa-itc/nos_time_driver.git ./sims/nos_time_driver
git submodule add -f -b nos3-main https://github.com/nasa-itc/sim_common.git ./sims/sim_common
git submodule add -f -b nos3-main https://github.com/nasa-itc/sim_server.git ./sims/sim_server
git submodule add -f -b nos3-main https://github.com/nasa-itc/sim_terminal.git ./sims/sim_terminal
git submodule add -f -b nos3-main https://github.com/nasa-itc/truth_42_sim.git ./sims/truth_42_sim
